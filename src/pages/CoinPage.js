            ...
            <div className={classes.sidebar}>
                ...
                <div className={classes.marketData}>
                    <span style={{ display: "flex" }}>
                        ...
                        &nbsp; &nbsp;
                        <Typography variant="h6" style={{ fontFamily: "Montserrat" }}>{coin?.market_cap_rank}</Typography>
                    </span>

                    <span style={{ display: "flex" }}>
                        <Typography variant="h6" className={classes.heading}>Current Price : </Typography>
                        &nbsp; &nbsp;
                        <Typography variant="h6" style={{ fontFamily: "Montserrat" }}>{symbol}{" "}{numberWithCommas(coin?.market_data.current_price[currency.toLowerCase()])}</Typography>
                    </span>
                    ...
                    {user && (
                        <Button
                            ...
                            style={{
                                ...
                                backgroundColor: inWatchlist ? "#ff0000" : "#32cd32",
                                fontWeight: "bold"
                            }}>
